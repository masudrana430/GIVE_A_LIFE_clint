        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="rounded-3xl border border-slate-100 bg-base-100 shadow-2xl p-6 md:p-8">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
              ...
              <div className="rounded-2xl border border-slate-100 bg-base-200/40 px-4 py-3">
                <p className="text-[11px] uppercase tracking-wide text-slate-500 font-semibold">
                  Last updated
                </p>
                <p className="text-sm font-bold text-slate-900 mt-1">{updated}</p>
              </div>
            </div>
          ...
          {/* Body */}
          <div className="mt-6 rounded-3xl border border-slate-100 bg-base-100 shadow-2xl p-6 md:p-8 space-y-6">
            <div>
              ...
              <ul className="mt-2 list-disc pl-5 text-sm text-slate-600 space-y-2">
                <li>
                  <span className="font-semibold text-slate-900">Account data:</span>{" "}
                  name, email, and authentication details (e.g., Firebase user ID).
                </li>
                <li>
                  <span className="font-semibold text-slate-900">Profile data:</span>{" "}
                  blood group, district, upazila, and availability (if you provide it).
                </li>
                <li>
                  <span className="font-semibold text-slate-900">Request data:</span>{" "}
                  donation requests you create (recipient info, hospital, time, location, message).
                </li>
                <li>
                  <span className="font-semibold text-slate-900">Usage data:</span>{" "}
            ...
            <div>
              ...
              <ul className="mt-2 list-disc pl-5 text-sm text-slate-600 space-y-2">
                <li>Provide core features like donor search and request management.</li>
                <li>Authenticate users and prevent unauthorized access.</li>
                <li>Show relevant donor/request information to enable coordination.</li>
                <li>Improve platform performance, reliability, and user experience.</li>
                <li>Respond to support inquiries and communicate important updates.</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600 leading-6">
                ...
                be shared only to support the donation coordination workflow.
              </p>
              <ul className="mt-2 list-disc pl-5 text-sm text-slate-600 space-y-2">
                <li>
                  When you confirm a donation, your name and email may be shown to the requester.
                </li>
                <li>
                  When you create a request, request details are visible to donors/volunteers to enable response.
                </li>
                <li>
                  We may share information if required by law or to protect platform safety.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600 leading-6">
                We use common security practices (authentication, access control,
                encrypted transport) to help protect your data. No method is
                100% secure; please use strong passwords and keep your device safe.
              </p>
            </div>
            ...
            <p className="text-[11px] text-slate-500">
              This page is a general template for your project. For production use,
              review with your organization/legal advisor and match your actual data flows.
            </p>
          </div>
        </div>
      </Container>
