  ...
  return (
    <Container>
      <section className="py-14 md:py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div
          className="
            rounded-3xl border border-base-200 shadow-2xl
            bg-base-100 p-6 md:p-8
            grid grid-cols-1 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1.5fr)] gap-8
          "
        >
          {/* Left: info */}
          <div className="flex flex-col justify-between gap-6">
            ...
            <div className="space-y-3 text-sm text-base-content/70">
              ...
              <div className="flex items-start gap-3">
                <span
                  className="
                    mt-0.5 inline-flex h-9 w-9 items-center justify-center
                    rounded-2xl bg-base-200/60 border border-base-200
                    text-rose-500
                  "
                >
            ...
            >
              <div className="form-control">
                ...
                <input
                  type="text"
                  name="name"
                  className="input input-bordered rounded-xl text-sm bg-base-100"
              ...
              <div className="form-control md:col-span-2">
                ...
                <textarea
                  name="message"
                  className="textarea textarea-bordered rounded-2xl text-sm min-h-[120px] bg-base-100"
